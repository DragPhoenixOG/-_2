...
class guessTheNumberGame extends JFrame
{
    ...
    public guessTheNumberGame()
    {
        ...
        j.setFont(new Font("calibri",Font.BOLD,30));
        j.setSize(350,30);
        j.setLocation(110,10);

        //Creating label Enter a number..... 
        JLabel j1=new JLabel("Enter a number between 1 to 100");
        j1.setFont(new Font("tunga",Font.PLAIN,17));
        j1.setSize(270,20);
        j1.setLocation(120,70);
